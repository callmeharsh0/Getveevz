...
export default function AgencyInfoCards() {
  ...
  return (
    ...
    >
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute bottom-1/4 right-1/4 w-[500px] h-[400px] bg-[#177DFD]/5 blur-[150px] rounded-full"
      />

      <div className="relative z-10 mx-auto max-w-5xl">
        {/* Section Header */}
        <div className="text-center max-w-3xl mx-auto mb-16 sm:mb-24">
          <span className="inline-flex items-center gap-2 rounded-full px-4 py-1.5 bg-white/[0.04] border border-white/[0.08] text-[10px] sm:text-xs font-mono uppercase tracking-[0.25em] text-frost/90 backdrop-blur-md mb-6 shadow-sm">
        ...
        {/* ========================================================================= */}
        {/* STACKING CARDS: Card 2 scrolls up and stacks on Card 1                    */}
        {/* ========================================================================= */}
        <div className="relative flex flex-col gap-12 sm:gap-16 pb-12">
          ...
          >
            <div className="group relative rounded-[2rem] sm:rounded-[2.5rem] p-[1.5px] bg-gradient-to-b from-white/[0.14] via-white/[0.04] to-transparent border border-white/[0.08] shadow-[0_24px_60px_rgba(0,0,0,0.6)]">
              <div className="rounded-[calc(2rem-1.5px)] sm:rounded-[calc(2.5rem-1.5px)] bg-[#0C131D]/95 p-6 sm:p-10 md:p-12 shadow-[inset_0_1px_1px_rgba(255,255,255,0.08)]">
                {/* Card Top Row */}
                <div className="flex flex-wrap items-center justify-between gap-4 pb-6 sm:pb-8 border-b border-white/[0.08]">
                  <div className="flex items-center gap-3">
                    <span className="flex items-center justify-center w-10 h-10 rounded-2xl bg-frost/10 border border-frost/20 text-frost font-mono text-xs font-bold">
                      01
                    </span>
                    <div>
                      <span className="font-mono text-[10px] sm:text-xs uppercase tracking-[0.2em] text-frost/90 font-medium">
                  ...
                  <div className="flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/[0.04] border border-white/[0.08] text-xs font-mono text-frost">
                ...
                <div className="pt-6 border-t border-white/[0.08] flex flex-col sm:flex-row items-center justify-between gap-4">
                  ...
                  <a
                    href="#pricing"
                    className="group/btn inline-flex items-center gap-3 rounded-full pl-6 pr-2.5 py-2 text-xs sm:text-sm font-semibold tracking-wide uppercase bg-moonlight text-oxford hover:bg-white transition-all duration-300 active:scale-[0.98] shadow-lg shrink-0"
                  >
                    <span>View Pricing Plans</span>
                    <span className="w-7 h-7 rounded-full bg-oxford/10 group-hover/btn:bg-oxford flex items-center justify-center transition-colors">
          ...
          >
            <div className="group relative rounded-[2rem] sm:rounded-[2.5rem] p-[1.5px] bg-gradient-to-b from-cyan-400/60 via-[#177DFD]/30 to-transparent border border-cyan-400/40 shadow-[0_32px_80px_rgba(23,125,253,0.25)]">
              <div className="rounded-[calc(2rem-1.5px)] sm:rounded-[calc(2.5rem-1.5px)] bg-[#091528]/98 p-6 sm:p-10 md:p-12 shadow-[inset_0_1px_1px_rgba(255,255,255,0.12)]">
                {/* Card Top Row */}
                <div className="flex flex-wrap items-center justify-between gap-4 pb-6 sm:pb-8 border-b border-white/[0.08]">
                  <div className="flex items-center gap-3">
                    <span className="flex items-center justify-center w-10 h-10 rounded-2xl bg-cyan-400/20 border border-cyan-400/40 text-cyan-300 font-mono text-xs font-bold shadow-sm">
                      02
                    </span>
                    <div>
                      <span className="font-mono text-[10px] sm:text-xs uppercase tracking-[0.2em] text-cyan-300 font-medium">
                  ...
                  <div className="flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-cyan-400/10 border border-cyan-400/30 text-xs font-mono text-cyan-300">
                ...
                {/* Primary Description */}
                <div className="py-6 sm:py-8">
                  <p className="text-base sm:text-xl text-white font-medium leading-relaxed max-w-2xl">
                    This will include the PR campaign and the mass clipping. Short term will be 25-30 days.
                  </p>

                  <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="p-4 rounded-2xl bg-white/[0.04] border border-white/[0.08]">
                      <div className="flex items-center gap-2 text-cyan-300 text-xs font-mono uppercase tracking-wider font-semibold mb-1">
                        <Zap className="w-4 h-4 text-cyan-400" />
                        <span>Mass Clipping Blitz</span>
                      </div>
                      <p className="text-xs sm:text-sm text-[#8BA3C5] leading-relaxed pl-6">
                ...
                <div className="pt-6 border-t border-white/[0.08] flex flex-col sm:flex-row items-center justify-between gap-4">
                  ...
                  <a
                    href="#pricing"
                    className="group/btn inline-flex items-center gap-3 rounded-full pl-6 pr-2.5 py-2 text-xs sm:text-sm font-semibold tracking-wide uppercase bg-cyan-400 text-oxford hover:bg-white transition-all duration-300 active:scale-[0.98] shadow-lg shrink-0"
                  >
                    <span>Launch 30-Day Sprint</span>
                    <span className="w-7 h-7 rounded-full bg-oxford/15 group-hover/btn:bg-oxford flex items-center justify-center transition-colors">
                      <ArrowUpRight className="w-3.5 h-3.5 text-oxford group-hover/btn:text-cyan-300 transition-transform group-hover/btn:translate-x-0.5 group-hover/btn:-translate-y-0.5" />
                    </span>
                  </a>
                </div>
              </div>
